...
class VtexView : ViewLayout<VtexViewModel>(), IVtexView {
  ...
  private val gridCtlrPEditor = PainelGridCtlrPEditor(this, viewModel.servicoVtexDiferenca())
  private val gridDiferencaRefList = PainelGridDiferencaRefList(this, viewModel.servicoVtexDiferenca())
  private val gridDiferencaCtlrPBase = PainelGridDiferencaCtlrPBase(this, viewModel.servicoVtexDiferenca())
